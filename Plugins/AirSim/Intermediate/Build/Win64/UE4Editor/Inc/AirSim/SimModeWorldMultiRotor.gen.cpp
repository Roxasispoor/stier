...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_ASimModeWorldMultiRotor()
	{
		...
		if (!OuterClass)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
				{ "IncludePath", "Multirotor/SimModeWorldMultiRotor.h" },
				{ "ModuleRelativePath", "Multirotor/SimModeWorldMultiRotor.h" },
			};
#endif
	...
	IMPLEMENT_CLASS(ASimModeWorldMultiRotor, 2615235612);
