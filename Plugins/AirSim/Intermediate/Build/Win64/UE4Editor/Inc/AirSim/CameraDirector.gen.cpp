...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AirSim_ECameraDirectorMode_CRC() { return 3635838813U; }
	UEnum* Z_Construct_UEnum_AirSim_ECameraDirectorMode()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "ECameraDirectorMode::CAMREA_DIRECTOR_MODE_BACKUP", (int64)ECameraDirectorMode::CAMREA_DIRECTOR_MODE_BACKUP },
			};
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "CAMREA_DIRECTOR_MODE_BACKUP.DisplayName", "Backup" },
	...
	IMPLEMENT_CLASS(ACameraDirector, 3154491008);
